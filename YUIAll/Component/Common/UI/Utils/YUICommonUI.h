...
extern NSString *const YUISelectedThemeIdentifier;
extern NSString *const YUIThemeIdentifierDefault;
extern NSString *const YUIThemeIdentifierGrapefruit;
extern NSString *const YUIThemeIdentifierGrass;
extern NSString *const YUIThemeIdentifierPinkRose;
extern NSString *const YUIThemeIdentifierDark;
...
@interface YUICommonUI : NSObject

+ (void)renderGlobalAppearances;
@end

@interface YUICommonUI (ThemeColor)

+ (UIColor *)randomThemeColor;
@end

@interface YUICommonUI (Layer)
