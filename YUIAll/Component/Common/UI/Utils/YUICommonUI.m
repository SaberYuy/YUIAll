...
NSString *const YUISelectedThemeIdentifier = @"selectedThemeIdentifier";
NSString *const YUIThemeIdentifierDefault = @"Default";
NSString *const YUIThemeIdentifierGrapefruit = @"Grapefruit";
NSString *const YUIThemeIdentifierGrass = @"Grass";
NSString *const YUIThemeIdentifierPinkRose = @"Pink Rose";
NSString *const YUIThemeIdentifierDark = @"Dark";

const CGFloat YUIButtonSpacingHeight = 72;

@implementation YUICommonUI
...
+ (void)renderGlobalAppearances {
    [YUIUIHelper customMoreOperationAppearance];
    [YUIUIHelper customAlertControllerAppearance];
    [YUIUIHelper customDialogViewControllerAppearance];
    [YUIUIHelper customImagePickerAppearance];
    [YUIUIHelper customEmotionViewAppearance];
    [YUIUIHelper customPopupAppearance];
...
@implementation YUICommonUI (ThemeColor)
...
@implementation YUICommonUI (Layer)
