...
- (instancetype)init {
    if (self = [super init]) {
        self.ya_backgroundColor = [UIColor qmui_colorWithName:@"ya_backgroundColor" themeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<YAThemeProtocol> *theme) {
            return theme.themeBackgroundColor;
        }];
        self.ya_backgroundColorLighten = [UIColor qmui_colorWithName:@"ya_backgroundColorLighten" themeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<YAThemeProtocol> * _Nullable theme) {
            return theme.themeBackgroundColorLighten;
        }];
        self.ya_backgroundColorHighlighted = [UIColor qmui_colorWithName:@"ya_backgroundColorHighlighted" themeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<YAThemeProtocol> *theme) {
            return theme.themeBackgroundColorHighlighted;
        }];
        self.ya_tintColor = [UIColor qmui_colorWithName:@"ya_tintColor" themeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<YAThemeProtocol> *theme) {
            return theme.themeTintColor;
        }];
        self.ya_titleTextColor = [UIColor qmui_colorWithName:@"ya_titleTextColor" themeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<YAThemeProtocol> *theme) {
            return theme.themeTitleTextColor;
        }];
        self.ya_mainTextColor = [UIColor qmui_colorWithName:@"ya_mainTextColor" themeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<YAThemeProtocol> *theme) {
            return theme.themeMainTextColor;
        }];
        self.ya_descriptionTextColor = [UIColor qmui_colorWithName:@"ya_descriptionTextColor" themeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<YAThemeProtocol> *theme) {
            return theme.themeDescriptionTextColor;
        }];
        self.ya_placeholderColor = [UIColor qmui_colorWithName:@"ya_placeholderColor" themeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<YAThemeProtocol> *theme) {
            return theme.themePlaceholderColor;
        }];
        self.ya_codeColor = [UIColor qmui_colorWithName:@"ya_codeColor" themeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<YAThemeProtocol> *theme) {
            return theme.themeCodeColor;
        }];
        self.ya_separatorColor = [UIColor qmui_colorWithName:@"ya_separatorColor" themeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<YAThemeProtocol> *theme) {
            return theme.themeSeparatorColor;
        }];
        self.ya_gridItemTintColor = [UIColor qmui_colorWithName:@"ya_gridItemTintColor" themeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<YAThemeProtocol> * _Nullable theme) {
            return theme.themeGridItemTintColor;
        }];
        
        self.ya_navigationBarBackgroundImage = [UIImage qmui_imageWithName:@"ya_navigationBarBackgroundImage" themeProvider:^UIImage * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<YAThemeProtocol> * _Nullable theme) {
        ...
        self.ya_tableViewCellDisclosureIndicatorImage = [UIImage qmui_imageWithName:@"ya_tableViewCellDisclosureIndicatorImage" themeProvider:^UIImage * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<YAThemeProtocol> * _Nullable theme) {
        ...
        self.ya_tableViewCellCheckmarkImage = [UIImage qmui_imageWithName:@"ya_tableViewCellCheckmarkImage" themeProvider:^UIImage * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<YAThemeProtocol> * _Nullable theme) {
            return [UIImage qmui_imageWithShape:QMUIImageShapeCheckmark size:CGSizeMake(15, 12) tintColor:self.ya_tintColor];
        }];
        self.ya_tableViewCellDetailButtonImage = [UIImage qmui_imageWithName:@"ya_tableViewCellDetailButtonImage" themeProvider:^UIImage * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<YAThemeProtocol> * _Nullable theme) {
            return [UIImage qmui_imageWithShape:QMUIImageShapeDetailButtonImage size:CGSizeMake(20, 20) tintColor:self.ya_tintColor];
        }];
        self.ya_searchBarTextFieldBackgroundImage = [UIImage qmui_imageWithName:@"ya_searchBarTextFieldBackgroundImage" themeProvider:^UIImage * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, __kindof NSObject<YAThemeProtocol> * _Nullable theme) {
            return [UISearchBar qmui_generateTextFieldBackgroundImageWithColor:theme.themeBackgroundColorHighlighted];
        }];
        self.ya_searchBarBackgroundImage = [UIImage qmui_imageWithName:@"ya_searchBarBackgroundImage" themeProvider:^UIImage * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, __kindof NSObject<YAThemeProtocol> * _Nullable theme) {
            return [UISearchBar qmui_generateBackgroundImageWithColor:theme.themeBackgroundColor borderColor:nil];
        }];
        
        self.ya_standardBlueEffect = [UIVisualEffect qmui_effectWithName:@"ya_standardBlueEffect" themeProvider:^UIVisualEffect * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<YAThemeProtocol> * _Nullable theme) {
