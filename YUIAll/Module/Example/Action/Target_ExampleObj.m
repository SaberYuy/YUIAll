...
- (UIViewController *)Action_nativeFetchExampleObjViewController:(NSDictionary *)params
{
    ...
    ExampleObjMVVMViewController *viewController = [[ExampleObjMVVMViewController alloc] init];
...
- (id)Action_showAlert:(NSDictionary *)params
{
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"alert from Module ExampleObj" message:params[@"message"] preferredStyle:UIAlertControllerStyleAlert];
