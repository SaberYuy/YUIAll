...
target :"YUIAll" do
  ...
  #   SUIMVVMKit is a MVVM frameWork easy to develop iOS
  #  pod 'SUIMVVMKit'
  ...
  #   JVFloatLabeledTextField is the first implementation of a UX pattern that has come to be known the "Float Label
  ...
  #    #   快捷好用的社会化分享组件|Convenient SDK for SNS Share Featur
  #    # 主模块(必须)
  #    pod 'ShareSDK3'
